...
<html lang="en">
    <head>
	    <meta charset="utf-8">
        <meta name="Mario And Asia Italian Restaurant" viewport="Mario And Asia About The Rastaurant">
	    ...
	    <title>Mario & Asia Italian Restaurant | About Us</title>
    </head>
            ...
            <input type="checkbox" id="check">
               <label for="check" class="checkbtn menu">
                ...
                <ul>
                    ...
                    <li><a class="active hover" href="about-us.php">About Us</a></li>
                    <li><a class="hover" href="faq.php">FAQ</a></li>
                    <li><a class="hover" href="contact-us.php">Contact Us</a></li>
                </ul>
        </nav>
        <br><br><br><br>
        <img class="abtus" src="assets/img/abtusfrontpage.webp">
            <div class="about-us">
                <div class="textmenu">
                    <p id="paboutus">This is the story of our humble resto.</p>
                </div>
                <div class="story1">
                        <p id="story-style1"><img class="abt-story1" src="assets/img/about-resto.webp">
                            The story began when Ms. Deslie Legaspi, along with her italian husband, started to open Mario and Asia Italian Restaurant 
                            on December 2019 at Santiago, General Trias, Cavite, Philippines.
                            <br><br>
                ...
                <div class="story2">
                        <p id="story-style2"><img class="abt-story2" src="assets/img/about-img.webp">
                            The story began when Ms. Deslie Legaspi, along with her italian husband, started to open Mario and Asia Italian Restaurant 
                            on December 2019 at Santiago, General Trias, Cavite, Philippines.
                            <br><br>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio, 
