...
<html lang="en">
    <head>
	    <meta charset="utf-8">
        <meta name="Mario And Asia Italian Restaurant" viewport="Mario And Asia Branch Gallery">
	    ...
	    <title>Mario & Asia Italian Restaurant | About Us - Branch Gallery</title>
    </head>
    ...
    background-repeat: repeat">
        ...
        <img class="abtus" src="assets/img/abtusfrontpage.webp">
            <div class="about-us">
                <div class="textmenu">
                    <p id="paboutus">Our Branch Stores Gallery</p>
                </div>
